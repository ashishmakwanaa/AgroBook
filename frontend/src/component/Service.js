...
const Service = () => {
  return (
    <div className='w-full h-full bg-gray-100 p-2 '>
        <h1 className=' text-4xl text-center pt-7 mb-6 relative after:block after:content-[attr(data-content)] after:bg-green-500 after:w-20 after:h-2 after:absolute after:top-19 after:w-36 after:rounded-2xl after:left-1/2 after:transform after:-translate-x-1/2 font-[Poppins]'>Our Services</h1>
        <div className="grid grid-cols-[repeat(auto-fit,minmax(350px,1fr))] gap-x-8 mt-12">
            <div className="relative bg-transparent text-center p-6 ml-3 rounded-lg text-sm cursor-pointer bg-[linear-gradient(#fffff 50%,#2c7bfe 50%)] bg-[100% 100%] bg-[0 2.5%] border-green-600 rounded-md p-4  border-b-8  bg-cover rounded-lg hover:bg-green-600 hover:text-white hover:scale-105 transition-transform duration-500 transition-background duration-500">
